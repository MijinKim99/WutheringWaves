...
#include "AttackCollision_SphereProjectile.generated.h"
...
UCLASS()
class WUTHERINGWAVES_API AAttackCollision_SphereProjectile : public AWWPooledObject
{
	GENERATED_BODY()

public:
	// Sets default values for this actor's properties
	AAttackCollision_SphereProjectile();
