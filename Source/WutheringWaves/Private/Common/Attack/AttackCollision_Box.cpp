...
#include "Common/Attack/AttackCollision_Box.h"
...
AAttackCollision_Box::AAttackCollision_Box()
{
...
void AAttackCollision_Box::BeginPlay()
{
	Super::BeginPlay();
	BoxComponent->OnComponentBeginOverlap.AddUniqueDynamic(this, &AAttackCollision_Box::OnBeginOverlap);
	BoxComponent->OnComponentHit.AddUniqueDynamic(this, &AAttackCollision_Box::OnHit);
}

void AAttackCollision_Box::SetActive(bool IsActive, APawn* InInstigator)
{
...
void AAttackCollision_Box::Deactivate()
{
	Super::Deactivate();
	HitTargetSet.Empty();
	BoxComponent->SetCollisionEnabled(ECollisionEnabled::NoCollision);
...
void AAttackCollision_Box::OnHitTargetActor(AActor* HitActor)
{
	// 중복 검사
...
void AAttackCollision_Box::OnBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
...
void AAttackCollision_Box::OnHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp,
	FVector NormalImpulse, const FHitResult& Hit)
{
}

void AAttackCollision_Box::InitializeAndAttackWithBox(float Duration, FVector BoxExtent, FVector Location,
                                                      ...
                                                      FGameplayTag InHitReactEventTag)
{
	...
	GetWorld()->GetTimerManager().SetTimer(DeactivateTimerHandle,this,&AAttackCollision_Box::Deactivate,Duration, false);
