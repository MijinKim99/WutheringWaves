...
#include "AbilitySystem/Abilities/WWGameplayAbility.h"
...
void UWWGameplayAbility::EndAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
